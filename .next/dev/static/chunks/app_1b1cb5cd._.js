...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                __turbopack_context__.A("[project]/node_modules/firebase/analytics/dist/esm/index.esm.js [app-client] (ecmascript, async loader)").then({
                    "Home.useEffect": ({ getAnalytics })=>{
                        const analytics = getAnalytics(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
    ...
    const checkSubscription = async (userId)=>{
        try {
            const { collection, getDocs, doc, getDoc } = await __turbopack_context__.A("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
            const organizationsSnapshot = await getDocs(collection(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'organizations'));
            for (const orgDoc of organizationsSnapshot.docs){
                const userInOrgDoc = await getDoc(doc(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], `organizations/${orgDoc.id}/users/${userId}`));
                if (userInOrgDoc.exists()) {
                    // Проверяем подписку организации
                    const subDoc = await getDoc(doc(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], `organizations/${orgDoc.id}/subscription/current`));
                    if (!subDoc.exists()) {
...
_s(Home, "XOYDKeaXCYDh4lucmAJlSy3Ac78=", false, function() {
    return [
...
//# sourceMappingURL=app_1b1cb5cd._.js.map