...
;
;
const StringsContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])();
const StringsProvider = ({ children })=>{
    ...
    const [theme, setTheme] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('system'); // 'light', 'dark', 'system'
    const [actualTheme, setActualTheme] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('light'); // Реальная применяемая тема
    ...
    const applyTheme = (newTheme)=>{
        ...
        // Если выбрана системная тема, получаем её значение
        if (newTheme === 'system') {
            themeToApply = getSystemTheme();
        }
        // Применяем класс темы
        root.classList.add(themeToApply);
        // Принудительно устанавливаем атрибут для CSS селекторов
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StringsProvider.useEffect": ()=>{
            ...
            const handleSystemThemeChange = {
                "StringsProvider.useEffect.handleSystemThemeChange": ()=>{
                    // Применяем изменение только если выбрана системная тема
                    if (theme === 'system') {
                        applyTheme('system');
                    }
                }
    ...
    const t = (key)=>{
        const keys = key.split('.');
        let value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$assets$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getString"])(keys[0], language);
        for (const k of keys.slice(1)){
            value = value?.[k];
        }
        return value || key;
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StringsContext.Provider, {
        value: {
            language,
            changeLanguage,
            theme,
        ...
        fileName: "[project]/app/hooks/useStrings.js",
        lineNumber: 110,
        columnNumber: 9
    }, ("TURBOPACK compile-time value", void 0));
};
_s(StringsProvider, "bd6X7gE8DCtdH9QcCNIsRNH1aE4=");
_c = StringsProvider;
const useStrings = ()=>{
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(StringsContext);
    if (!context) {
        throw new Error('useStrings must be used within a StringsProvider');
    }
    return context;
};
_s1(useStrings, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "StringsProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/components/ClientProviders.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// Создайте app/components/ClientProviders.js
__turbopack_context__.s([
    "default",
    ()=>ClientProviders
]);
...
function ThemeWrapper({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeWrapper.useEffect": ()=>{
            ...
            const savedTheme = localStorage.getItem('theme') || 'system';
            const getSystemTheme = {
                "ThemeWrapper.useEffect.getSystemTheme": ()=>{
                    return window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light';
                }
            }["ThemeWrapper.useEffect.getSystemTheme"];
...
function ClientProviders({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useStrings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StringsProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ThemeWrapper, {
            ...
            fileName: "[project]/app/components/ClientProviders.js",
            lineNumber: 27,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
//# sourceMappingURL=app_ec401592._.js.map