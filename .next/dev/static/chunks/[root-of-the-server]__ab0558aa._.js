...
const StringsProvider = ({ children })=>{
    ...
    const t = (key)=>{
        const keys = key.split('.');
        let value = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$assets$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"][language];
        for (const k of keys){
            value = value?.[k];
        }
        return value || key;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab0558aa._.js.map