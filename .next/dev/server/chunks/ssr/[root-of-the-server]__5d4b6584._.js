...
;
const metadata = {
    title: "GeoNote - Геопространственные заметки",
    description: "Создавайте, управляйте и анализируйте геопространственные заметки и проекты",
    keywords: "геология, картография, заметки, проекты, геопространственные данные",
    authors: [
        {
            name: "GeoNote Team"
        }
